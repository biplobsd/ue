...
// Ported from Aster (app/src/main/java/me/bmax/apatch/ui/component/FloatingBottomBar.kt).
package dev.updateengine.hyperos.core.ui.glass
...
import dev.updateengine.hyperos.core.ui.theme.LocalAppDarkTheme
...
/**
 * Space a screen must leave at the bottom of its scrolling content so the last item clears the
 * capsule: 64dp bar + 12dp vertical padding + 12dp breathing room.
 */
val FloatingBottomBarClearance = 88.dp
...
fun FloatingBottomBar(
    ...
    val isInLightTheme = !LocalAppDarkTheme.current
